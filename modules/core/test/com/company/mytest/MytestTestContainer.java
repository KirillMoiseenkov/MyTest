...
public class MytestTestContainer extends TestContainer {

    public MytestTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/mytest/app.properties",
    ...
    public static class Common extends MytestTestContainer {

        public static final MytestTestContainer.Common INSTANCE = new MytestTestContainer.Common();
